...
<design-principle id="A" name="Layout Pattern">
Name one per prompt:
...
<design-principle id="B" name="Intentional Text Placement" required="true">
...
<design-principle id="C" name="Canvas Zone Map" dimensions="1030x1350">
...
<design-principle id="D" name="Typography Hierarchy">
...
<design-principle id="E" name="Text Readability Technique">
...
<design-principle id="F" name="Eye Flow" required="true">
...
Integrated with layout -- reference Design Principles D and E:
...
The 3-step reading path per Design Principle F (FIRST: what stops the scroll -> SECOND: what the eye moves to -> THIRD: CTA).
</field>
